...
lyr_HLDIEN_3.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_CHUNGCU_4.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', 'DANSOCHUNGCU': 'header label - always visible', });
lyr_HANHCHINH_5.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_TTVH_6.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_CHO_7.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_CAYXANG_8.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_BIETTHU_9.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', 'DANSOBT': 'header label - always visible', });
lyr_TRUONGHOC_10.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_LIENKE_11.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', 'DANSO': 'header label - always visible', });
lyr_DUONG_12.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_CAYXANH_13.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'SHAPE_Area': 'header label - always visible', });
lyr_CONG_14.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', 'D': 'header label - always visible', 'DOC_I': 'header label - always visible', 'Q_MUA': 'header label - always visible', 'Q_CONG': 'header label - always visible', 'V': 'header label - always visible', 'H_D': 'header label - always visible', 'H_D_20': 'header label - always visible', });
lyr_HOGAA_15.set('fieldLabels', {'OBJECTID': 'header label - always visible', 'SHAPE_Length': 'header label - always visible', });
